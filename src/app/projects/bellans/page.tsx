...
export default function ProjectBellans() {
  const project = {
    overview: {
      title: "Bellans Mental Health App",
      description: "SPL Mental Health System is your sanctuary for emotional growth and healing. The platform provides 24/7 mental health resources, personalized self-care plans, and connects users with certified mental health professionals in a secure, judgment-free environment.",
      image: "/assets/images/bellans.png",
