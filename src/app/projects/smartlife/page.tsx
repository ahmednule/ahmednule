...
export default function projectSmartLife() {
  const project = {
    overview: {
      title: "SmartLife",
      description:"Smart-Life is a Next.js project that aims to revolutionize local transport by offering an AI-powered tracking and navigation web app, making city life easier and more convenient with on-demand ride sharing and predictive routing.",
    ...
    caseStudy: [
      {
        title: "Problem",
        description:"Urban transportation faces significant challenges with unreliable local transport systems, long waiting times, and inefficient routing. Passengers struggle to find available rides while drivers waste time and fuel searching for customers, leading to increased costs and reduced efficiency in city transportation.",
        icon: AlertTriangle,
