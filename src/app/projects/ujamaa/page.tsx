...
export default function projectUjamaaFoundation() {
  const project = {
    overview: {
      title: "Ujamaa Foundation",
      description:"Ujamaa Foundation is a non-profit, community-based, and youth-led organization website that empowers communities in North Eastern Kenya through sustainable development initiatives including peace building, education support, environmental restoration, and capacity building.",
      image: "/assets/images/ujamaa.png",
    ...
    caseStudy: [
      {
        title: "Problem",
        description:"Marginalized communities in northern Kenya face significant challenges including limited access to education, environmental degradation, community conflicts, and lack of development opportunities. These communities needed a platform to showcase their work and connect with supporters and partners.",
        icon: AlertTriangle,
      ...
      {
        title: "Solution",
        description:"Created a comprehensive website for Ujamaa Foundation that effectively communicates their mission, showcases their six strategic programs, highlights community impact, and provides easy ways for supporters to engage. The platform serves as a digital hub for community empowerment and sustainable development initiatives.",
        icon: Lightbulb,
      ...
      {
        title: "Outcome",
        description:"The website successfully represents Ujamaa Foundation's commitment to community empowerment, providing a professional platform that enhances their visibility, credibility, and ability to attract partnerships and support for their vital community development work in northern Kenya.",
        icon: ThumbsUp,
