...
export default function projectcoffehuub() {
  const project = {
    overview: {
      title: "CoffeeHub",
      description: "A transparent and efficient platform connecting discerning buyers with premium coffee growers. CoffeeHub provides a comprehensive solution for the coffee industry, ensuring quality, transparency, and efficiency from farm to cup with complete traceability.",
      image: "/assets/images/coffeehub.png",
    ...
    caseStudy: [
      {
        title: "Problem",
        description:"The coffee industry lacks transparency and efficient connections between growers and buyers. Coffee professionals struggle with fragmented systems, limited traceability, and difficulty in verifying quality certifications, leading to inefficiencies and reduced trust in the supply chain.",
        icon: AlertTriangle,
      ...
      {
        title: "Solution",
        description: "CoffeeHub creates a comprehensive marketplace that connects all stakeholders in the coffee industry through a transparent, efficient platform. The system provides complete traceability, quality certification tracking, and tailored tools for each type of coffee professional, from growers to roasters.",
        icon: Lightbulb,
